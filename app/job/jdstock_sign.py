...
class JDStock_Sign(Job):
    ...
    UA = 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_2_1 like Mac OS X) AppleWebKit/604.4.7 (KHTML, like Gecko) Mobile/15C153 JDStockApp_iOS_2.0.0 jdstock-iphone_2.0.0 JDStockApp_iOS_1.6.0'
